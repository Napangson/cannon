...
<center><img src="img/<?=$data['p_picture'];?>" width="200" height="180"></center>
<div class="caption">
<a href="detail.php?id=<?=$data['p_id'];?>" >
<h6><?=$data['p_name'];?></h6>
<h6><?=number_format($data['p_price'],0);?> บาท</h6>
<p><a href="cart.php?id=<?=$data['p_id'];?>" class="btn btn-primary" role="button">หยิบลงตะกร้า</p></a> 
</div>
</div>
</div>
<?php
